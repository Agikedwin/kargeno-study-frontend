...
const AddCallVisit = props => {
  const classes = useStyles();
  const { open, onClose,saveService, visitServices, visitCalls,className, ...rest } = props;
        ...
        <form>
          ...
          <CardActions className={classes.actions}>
            ...
            <Button
              ...
              onClick={() =>{
                formState.visitId = visitCalls.visitId,
                formState.callVisitId = visitCalls._id,
...
AddCallVisit.displayName = 'Add Phone Call';

AddCallVisit.propTypes = {
...
AddCallVisit.defaultProps = {
  open: false,
  onClose: () => {}
};

export default AddCallVisit;
